...
print('<input type="text" class="form-control" id="gene_form" placeholder="Enter a gene name">')
print('</div>')
...
print('<input type="text" class="form-control" id="transcript_form" placeholder="Enter a transcript name">')
print('</div>')
print('<button type="submit" class="btn btn-primary">Submit</button>')
print('</form>')
