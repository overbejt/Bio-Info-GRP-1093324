...
print('<form action="results.py" method="get">')
print('<div class="form-group">')
print('<label for="gene_form">Search for a Gene</label>')
print('<input type="text" class="form-control" name="gene_form" placeholder="Enter a gene name">')
print('</div>')
print('<button type="submit" class="btn btn-primary">Search</button>')
print('</form>')
...
print('<input type="text" class="form-control" name="transcript_form" placeholder="Enter a transcript name">')
print('</div>')
print('<button type="submit" class="btn btn-primary">Search</button>')
print('</form>')
